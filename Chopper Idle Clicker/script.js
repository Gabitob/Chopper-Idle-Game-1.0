$(document).ready(function(){
    ...
    $("#mineStone").click(function(){
        if(pickaxes == 0){
            alert("Você não tem nada pra minerar pedras!");
        }else{
            stone += stonePlus;
            changeInventory();
        }
    ...
    function changeInventory(){
        ...
        if(logs == 1){
            $("#logs").html("Você agora tem " + logs + " madeiras.");
        }else{
            $("#logs").html("Você agora tem " + logs + " madeiras.");
        }

        if(stone > 0){
            $("#stone").html("Você agora tem " + stone + " pedaço(s) de pedra(s).");
        }else{
            $("#stone").html("");
        }

        if(pickaxes > 0){
            $("#pickaxes").html("Você agora tem " + pickaxes + " picareta(s).");
        }else{
            $("#pickaxes").html("");
        }
    }
